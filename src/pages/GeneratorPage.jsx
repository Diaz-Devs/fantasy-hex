    ...
    <div className="generator-container">
      ...
      {boardData && (
        <div style={{
          ...
          <div>
            <div style={{ fontSize: '0.75rem', color: 'var(--slate-muted)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              Board Seed
            </div>
            <div style={{ fontFamily: 'var(--font-heading)', fontSize: '0.9375rem', fontWeight: 500 }}>
              #{boardData.seed?.substring(0, 12)}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ fontFamily: 'var(--font-heading)', fontSize: '0.9375rem', fontWeight: 500 }}>
              {boardData.mode === 'normal' ? 'Standard' : 'Expanded'}
            </div>
          </div>
          ...
          <div>
            ...
            <div style={{ fontFamily: 'var(--font-heading)', fontSize: '0.9375rem', fontWeight: 500 }}>
              {Object.values(boardData.resourceSummary || {}).reduce((a, b) => a + b, 0)} tiles
            </div>
          </div>
